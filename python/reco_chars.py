...
class CaffeCls(object):
    ...
    def _predict_cv2_imgs_sub(self, cv2_imgs, pos_start, pos_end):
        ...
        #print(cv2_imgs_sub)
        self.net.blobs['data'].reshape(cv2_imgs_sub.shape[0], 1, self.width, self.height)

        self.net.blobs['data'].data[...] = cv2_imgs_sub.reshape((cv2_imgs_sub.shape[0], 1, self.width, self.height))
...
class PreprocessResizeKeepRatioFillBG(object):
    ...
    def put_img_into_center(cls, img_large, img_small, ):
        ...
        img_large[int(start_height):int(start_height) + int(height_small),
                  int(start_width):int(start_width) + int(width_small)] = img_small
        return img_large
...
if __name__ == "__main__":
    ...
    base_dir = "/home/user/Projects/deep_ocr_workspace/data/chongdata_caffe_cn_sim_digits_64_64"
    ...
    test_image = "/home/user/Projects/data/test_data.png"

    debug_dir = "/home/user/Projects/data/caffe_dataset_cn_sim/debug_dir"
